...
<nav style="background-color: #0000;" class="navbar navbar-expand-lg bg-body-tertiary">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown tramite">
            ...
            <ul class="dropdown-menu">
              <li><a class="dropdown-item" href="iniciarSesion.php">Afiliación</a></li>
              <li><a class="dropdown-item" href="iniciarSesion.php">Cita médica</a></li>
              <li><a class="dropdown-item" href="iniciarSesion.php">Solicitud carnet</a></li>
              <li><a class="dropdown-item" href="iniciarSesion.php">Incapacidad laboral</a></li>
           </ul>
          </li>
          <!-- Fin desplegable -->
         </ul>
         <a class="iniciaSesion" href="iniciarSesion.php">Iniciar sesión</a>
      </div>
    </div>
